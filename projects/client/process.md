...
![my markup for the website layout](media/Layout.png)

it had a title/hero, 3 cards with info, a sidebar with links, and text.

This was based on my taco truck webpage, which had a similar layout.

When I started developing, I copied the style.css and index.html from my taco truck webpage. I then added links to the sidebar that were nested in lists. I cleaned up some of the styling, fiddled with sticky positions, and added the .js validator. I then realized that the cards that were in my previous layout don't really have a purpose, so I removed them. I then changed the background colors, and started work on the other pages.  
